const apiURL =
  "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=1925537df249e2feeb9c942f8dcf140e&units=imperial";
...
fetch(apiURL)
  ...
  .then((jsObject) => {
    ...
    document.querySelector("#wchill").innerHTML = `<b>${chill}</b>`;
  });
const castURL =
  "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=1925537df249e2feeb9c942f8dcf140e&units=imperial";
